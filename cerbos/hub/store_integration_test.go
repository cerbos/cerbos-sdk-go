...
func testReplaceFiles(client *hub.StoreClient, storeID string) func(*testing.T) {
	return func(t *testing.T) {
		...
		t.Run("InvalidRequest", func(t *testing.T) {
			_, err := client.ReplaceFiles(context.Background(), hub.NewReplaceFilesRequest(storeID, "Replace", []byte("zip")))
		...
		t.Run("InvalidFiles", func(t *testing.T) {
			...
			_, err = client.ReplaceFiles(context.Background(), hub.NewReplaceFilesRequest(storeID, "Replace", zippedData))
		...
		t.Run("UnsuccessfulCondition", func(t *testing.T) {
			...
			req := hub.NewReplaceFilesRequest(storeID, "Replace", zippedData).OnlyIfVersionEquals(math.MaxInt64)
