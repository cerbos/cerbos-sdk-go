...
func (m *Policy) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.JsonSchema) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.JsonSchema)))
		i--
		dAtA[i] = 0x4a
	}
...
func (m *Variables) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Import) > 0 {
		for iNdEx := len(m.Import) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.Import[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *TestOptions) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Now != nil {
		if vtmsg, ok := interface{}(m.Now).(interface {
			...
			encoded, err := proto.Marshal(m.Now)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *TestResults_Summary) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TestsCount != 0 {
		i = encodeVarint(dAtA, i, uint64(m.TestsCount))
		i--
		dAtA[i] = 0x10
	}
	if m.OverallResult != 0 {
		i = encodeVarint(dAtA, i, uint64(m.OverallResult))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *TestResults_OutputFailure_MismatchedValue) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Actual != nil {
		if vtmsg, ok := interface{}(m.Actual).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.Actual)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
	...
	if m.Expected != nil {
		if vtmsg, ok := interface{}(m.Expected).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.Expected)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *TestResults_OutputFailure) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Src) > 0 {
		i -= len(m.Src)
		copy(dAtA[i:], m.Src)
		i = encodeVarint(dAtA, i, uint64(len(m.Src)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *TestResults_Failure) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Actual != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Actual))
		i--
		dAtA[i] = 0x10
	}
	if m.Expected != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Expected))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *TestOptions) SizeVT() (n int) {
	...
	_ = l
	if m.Now != nil {
		if size, ok := interface{}(m.Now).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
...
func (m *TestResults_Summary) SizeVT() (n int) {
	...
	_ = l
	if m.OverallResult != 0 {
		n += 1 + sov(uint64(m.OverallResult))
	}
	if m.TestsCount != 0 {
		n += 1 + sov(uint64(m.TestsCount))
	}
	if len(m.ResultCounts) > 0 {
...
func (m *TestResults_OutputFailure_MismatchedValue) SizeVT() (n int) {
	...
	_ = l
	if m.Expected != nil {
		if size, ok := interface{}(m.Expected).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.Expected)
		}
		n += 1 + l + sov(uint64(l))
	}
	if m.Actual != nil {
		if size, ok := interface{}(m.Actual).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.Actual)
		}
		n += 1 + l + sov(uint64(l))
	}
	n += len(m.unknownFields)
...
func (m *TestResults_Failure) SizeVT() (n int) {
	...
	_ = l
	if m.Expected != 0 {
		n += 1 + sov(uint64(m.Expected))
	}
	if m.Actual != 0 {
		n += 1 + sov(uint64(m.Actual))
	}
	if len(m.Outputs) > 0 {
		for _, e := range m.Outputs {
			l = e.SizeVT()
...
func (m *TestOptions) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Now == nil {
				m.Now = &timestamppb.Timestamp{}
			}
			if unmarshal, ok := interface{}(m.Now).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Now); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *TestResults_OutputFailure_MismatchedValue) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Expected == nil {
				m.Expected = &structpb.Value{}
			}
			if unmarshal, ok := interface{}(m.Expected).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Expected); err != nil {
					return err
				}
			}
			iNdEx = postIndex
		case 2:
			...
			if m.Actual == nil {
				m.Actual = &structpb.Value{}
			}
			if unmarshal, ok := interface{}(m.Actual).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Actual); err != nil {
					return err
				}
			}
			iNdEx = postIndex
